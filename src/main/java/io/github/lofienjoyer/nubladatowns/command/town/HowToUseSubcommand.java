...
public class HowToUseSubcommand implements BiConsumer<CommandSender, String[]> {

    private final LocalizationManager localizationManager;
    private final TownManager townManager;

    public HowToUseSubcommand(TownManager townManager) {
    ...
    public void accept(CommandSender sender, String[] args) {
        ...
        TownUtils.showHowToUseBook(player, town);
    }
} 