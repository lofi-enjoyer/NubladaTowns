...
public class RolesSubcommand implements BiConsumer<CommandSender, String[]> {

    private final LocalizationManager localizationManager;
    private final TownManager townManager;

    public RolesSubcommand(TownManager townManager) {
    ...
    public void accept(CommandSender sender, String[] args) {
        ...
        TownUtils.showRolesList(player, town);
    }
